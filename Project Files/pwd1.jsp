...
<div class="navbar">
  ...
  <a href="mydiary.html" target="_self"><i class="fa fa-fw fa-edit"></i>Diary</a>
  <a href="remainder.html" target="_self"><i class="fa fa-fw fa-bell"></i>Remainder</a>
</div>
<div class="center1">
...
<div class="wrapper">
         ...
         <form action="pwd.jsp">
            ...
            <pre>    <label id="invalid3" name="invalid"></label></pre>
            <div class="field">
