...
out.print("...."+name1+"'s Remainder...");
%>
</form></h1>
</div>
<div class="center2">
<a href="remainderr.jsp" target="_self" ><i class="fa fa-fw fa-profile"></i><h1><input class="but" type="button" value="New task"></h1> </a>
</div>
<div class="center">
...
String sql ="select * from task where email='"+name+"' order by time desc";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr>
<td width="30%"><%=resultSet.getString("date") %></td>
<td width="40%"><div style="width:100%;height:100%;margin:0;padding:0;overflow:auto"><%=resultSet.getString("task") %></div>
</td>
<td width="30%"><%=resultSet.getString("time") %></td>
<td width="20%><div class="center4">
